...
model_name = 'Scripting_My_Investigation_CS_325_Particles'
...
openMdb(
    pathName='D:\Pipe\Tesis\ABAQUS_Various\CAEs\Cold_Spray_3D\My_Investigation_2021/FOR_SCRIPTING_Particles/My_Investigation_for_scripting_particles.cae')
